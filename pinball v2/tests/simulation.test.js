...
(function testCopperMergePocketUnsticks() {
  ...
  assert(sim.HABITRAIL_ASSIST === 0, 'HABITRAIL_ASSIST stays 0');
  assert(sim.BOINGER_B_X === 398 && sim.BOINGER_B_Y === 740, 'B at 398,740 (down-right outlane)');
...
(function testPop1TriangleAndDumbbell() {
  ...
  assert(renSrcPop.indexOf('clipPtsAtJoinX(outer, 470') !== -1, 'horseshoe hull meets copper slide at x=470');
