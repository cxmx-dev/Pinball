...
(function testOpt2FlipperReleaseAndRestartHit() {
  ...
  assert(html.indexOf('?v=dump5') !== -1 && html.indexOf('?v=dump3') === -1 && html.indexOf('?v=shoe6') === -1 && html.indexOf('?v=opt1') === -1 && html.indexOf('?v=shoe2') === -1 && html.indexOf('?v=shoe5') === -1, 'cache bust dump5');
